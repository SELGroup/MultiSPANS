...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str,
                        default='STTransformer', help='the name of model')
    # parser.add_argument('--model', type=str,
    #                     default='STTN', help='the name of model')
    ...
    parser.add_argument('--scalar', type=str, default='standard', help='normalization of dataset')
    ...
    args.load_external = True
    args.add_day_in_week = True
